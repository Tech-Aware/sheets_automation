...
const MONTHLY_LEDGER_INDEX = Object.freeze({
  ...
  FRAIS_LIBELLE: MONTHLY_LEDGER_HEADERS.indexOf('FRAIS | LIBELLÉS'),
  FRAIS_TYPE: MONTHLY_LEDGER_HEADERS.indexOf('FRAIS | TYPE'),
  FRAIS_MONTANT: MONTHLY_LEDGER_HEADERS.indexOf('FRAIS | MONTANT')
});

const LEDGER_FEE_TYPE_OPTIONS = Object.freeze([
  'Gestion',
  'Matériels',
  'Logistique',
  'Amortissement',
