...
const MONTHLY_LEDGER_INDEX = Object.freeze({
  ...
  TAXES: MONTHLY_LEDGER_HEADERS.indexOf('TAXES'),
  COUT_REVIENT: MONTHLY_LEDGER_HEADERS.indexOf("COUT DE REVIENT"),
  BENEFICE_NET: MONTHLY_LEDGER_HEADERS.indexOf('BENEFICE NET'),
  NB_PIECES: MONTHLY_LEDGER_HEADERS.indexOf('NBR PCS VENDU'),
  // Anciens noms gardés pour compatibilité
  PRIX_ACHAT: MONTHLY_LEDGER_HEADERS.indexOf("COUT DE REVIENT"),
  MARGE_BRUTE: MONTHLY_LEDGER_HEADERS.indexOf('BENEFICE NET'),
  COEFF_MARGE: -1 // Plus utilisé
});

const LEDGER_FEES_TABLE = Object.freeze({
  START_COLUMN: 12, // Colonne L (décalé de 1 suite à l'ajout de TAXES)
